      ...
      <div className="container my-5">
        <div className="row">
          ...
          <div className="col-md-6">
            ...
            <h3 className="text-danger">₹{product.price} <small className="text-muted text-decoration-line-through">₹{product.mrp}</small> <span className="text-success">({Math.round(((product.mrp - product.price) / product.mrp) * 100)}% off)</span></h3>
